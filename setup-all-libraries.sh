...
setup-library https://github.com/leapmotion/autowiring.git 1.0.4 -g -b "fix-arm" -o autowiring-1.0.4
setup-library https://github.com/leapmotion/leapserial.git 0.4.0 -g -b "fix-arm" -o leapserial-0.4.0
