...
./setup-library.sh https://www.libsdl.org/release/SDL2-2.0.4.zip 2.0.4 ${INSTALL_ROOT} -s "SDL2-2.0.4" -o "SDL2-2.0.4" -n "SDL2"
./setup-library.sh https://sourceforge.net/projects/glew/files/glew/1.13.0/glew-1.13.0.zip 1.13.0 ${INSTALL_ROOT} -s "glew-1.13.0" -o "glew-1.13.0" -n "glew"
./setup-library.sh http://downloads.sourceforge.net/freeimage/FreeImage3170.zip 3.17.0 ${INSTALL_ROOT} -s "FreeImage" -o "freeimage-3.17.0" -n "freeimage"
./setup-library.sh http://downloads.sourceforge.net/project/anttweakbar/AntTweakBar_116.zip 1.16 ${INSTALL_ROOT} -s "AntTweakBar" -o "AntTweakBar-1.16.0" -n "anttweakbar"
./setup-library.sh git@github.com:bulletphysics/bullet3.git 2.84.0 ${INSTALL_ROOT} -b @d5d8e16
