...
setup-library git@github.com:openssl/openssl.git 1.0.2k
...
setup-library https://curl.haxx.se/download/curl-7.53.1.zip 7.53.1 -n curl -o "curl-7.53.1"
setup-library git://code.qt.io/qt/qt5.git 5.8.0 -o "qt-5.8.0"
setup-library git@github.com:google/flatbuffers.git 1.3.0
setup-library git@github.com:google/protobuf.git 3.0.0
...
setup-library https://www.libsdl.org/release/SDL2-2.0.4.zip 2.0.4 -s "SDL2-2.0.4" -o "SDL2-2.0.4" -n "SDL2"
...
setup-library git@github.com:leapmotion/anttweakbar.git 1.16 -s "AntTweakBar" -b "develop"
