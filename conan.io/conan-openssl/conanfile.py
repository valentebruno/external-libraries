...
class OpenSSLConan(ConanFile):
    ...
    url="http://github.com/leapmotion/conan-openssl"
    ...
    def config_options(self):
        ...
        if not self.options.no_electric_fence and self.settings.os == "Linux":
            ...
            if self.counter_config==2:
                self.requires.add("electric-fence/2.2.0@leapmotion/stable", private=private)
        ...
        if not self.options.no_zlib:
            self.requires.add("zlib/1.2.8@leapmotion/stable", private=False)
