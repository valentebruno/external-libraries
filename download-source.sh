...
QT_URL=http://download.qt.io/official_releases/qt/5.6/5.6.0/single/qt-everywhere-opensource-src-5.6.0.zip
...
download qt-everywhere-opensource-src-5.6.0 ${QT_URL}
