...
CC=aarch64-linux-gnu-gcc CFLAGS="-fPIC" ./configure --prefix="${EXTERNAL_LIBRARY_DIR}/sdl2-${SDL2_VERSION}" --disable-shared -enable-static --disable-audio --disable-joystick --disable-haptic --host=arm-linux
make -j 4 install
cd ..
